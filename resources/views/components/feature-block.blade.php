<div {{ $attributes->class(['group relative']) }}>
    <div class="absolute left-[calc(50%+20px)] top-[20px] hidden h-px w-[calc(100%-40px)] group-last:hidden sm:block bg-gradient-to-r from-primary-700/75 via-background-accent-hover to-primary-700/75"></div>
