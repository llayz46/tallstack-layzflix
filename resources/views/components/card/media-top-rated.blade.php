<a href="https://layzflix.llayz.fr/medias/522627-movie-the-gentlemen" wire:navigate
   {{ $attributes->class(['rounded-lg bg-background group relative after:absolute after:size-full after:bg-red-500 after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:-z-[1] after:p-0.5 after:box-content after:opacity-0 after:transition-opacity after:duration-300 hover:after:opacity-100 after:transform after:inset-0 after:rounded-lg after:bg-conic-gradient after:animate-border-spin']) }} data-turbo="false">
    <span class="sr-only">Link to The Gentlemen</span>
    <img src="https://image.tmdb.org/t/p/w500/jtrhTYB7xSrJxR1vusu99nvnZ1g.jpg" class="rounded-md w-full h-full"
         alt="Poster of : The Gentlemen" sizes="(max-width: 1300px) 300px" loading="lazy">
    ...
    <div class="hidden group-hover:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
        <h3 class="text-lg font-semibold text-primary-600 text-center">The Gentlemen</h3>
        <p class="mt-1 text-sm text-neutral-300 text-center">2020-01-01</p>
    </div>
</a>
